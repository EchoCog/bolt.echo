      ...
      {networkStatus && !isLoading && (
        <div className="space-y-4">
          <div className="flex items-center">
            ...
            <div className="flex items-center">
              <span
                className={`inline-block w-3 h-3 rounded-full mr-2 ${networkStatus.isConnected ? 'bg-green-500' : 'bg-red-500'}`}
              ></span>
          ...
          <div className="flex items-center">
            ...
            <div>{networkStatus.latencyMs > 0 ? `${networkStatus.latencyMs} ms` : 'Not available'}</div>
          </div>
          ...
          <div className="flex items-center">
            ...
            <div className="flex items-center">
              <span
                className={`inline-block w-3 h-3 rounded-full mr-2 ${networkStatus.dnsResolution ? 'bg-green-500' : 'bg-red-500'}`}
              ></span>
